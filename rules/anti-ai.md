...
> These are general writing-voice rules, not CV-specific — they apply to anything Claude writes for you, including this CV. Edit this file directly to add or remove anything; there's nothing sacred about this exact list. See `anti-ai-cv-addendum.md` for the handful of rules specific to resume bullets that this general doc doesn't cover.
